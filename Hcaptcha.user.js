 ...
 ***************************************************************************************************
 * MicroWallets:                                                                                   *
 * 1.) FaucetPay: BTC: 1He7kvNfiK176wR6XhLuJodi5yeu5ByNDu                                          *
 *     LTC: MHVQH4pejcdNgr8CMAqieETuhXi5YgNpGT                                                     *
 *     BCH: bitcoincash:qpndw7ng8g68p7sswd4kaas305gzt9vfsuatqheat9                                 *
 *     TRX: TQWFmq4gTcGp92Fnf9yYKbA2Vh4qGsKckn                                                     *
 *     Doge: DLTK2e3vKCtN79R9EdkaRh299Up9sMwpJJ                                                    *                                             *
 * 2.) Direct BTC: 35H7drwYcNRnwsRvVngFAKTPZu9Kg4k84n                                              *
 ***************************************************************************************************
...
(function() {
    ...
    async function selectImages() {
        ...
        if (qSelectorAll(IMAGE) && qSelectorAll(IMAGE).length == 9 && qSelector(NO_SELECTION).getAttribute(ARIA_HIDDEN) != true) {
            ...
            if(word && word != -1 && USE_COLOUR_PATTERN){
                for (let i = 0; i < 9; i++) {
